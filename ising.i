...
void update(const float temp, int grid[1024][1024]) {
  ...
  const float d = 1.0f / 4294967296.0f;;
  ...
  for (unsigned int i = 0; i < 1024; ++i) {
    for (unsigned int j = 0; j < 1024; ++j) {
      ...
      int spin_neigh_n = grid[(i + 1024 - 1) % 1024][j];
      int spin_neigh_e = grid[i][(j + 1) % 1024];
      int spin_neigh_w = grid[i][(j + 1024 - 1) % 1024];
      int spin_neigh_s = grid[(i + 1) % 1024][j];
...
double calculate(int grid[1024][1024], int *M_max) {
  ...
  for (unsigned int i = 0; i < 1024; ++i) {
    for (unsigned int j = 0; j < 1024; ++j) {
      int spin = grid[i][j];
      int spin_neigh_n = grid[(i + 1) % 1024][j];
      int spin_neigh_e = grid[i][(j + 1) % 1024];
      int spin_neigh_w = grid[i][(j + 1024 - 1) % 1024];
      int spin_neigh_s = grid[(i + 1024 - 1) % 1024][j];
